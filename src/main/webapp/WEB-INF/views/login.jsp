 ...
 <body class="login1">
    ...
    <div class="login-wrapper">
      <div class="login-container">
       <h3> <a href="＃">全媒体云库中心</a></h3>
        <form action="logininfo">
          <div class="form-group">
            <input name="username" class="form-control" placeholder=" 用 户 名" type="text">
          </div>
          <div class="form-group">
            <input name="password" class="form-control" placeholder=" 密 码" type="text"><input type="submit" value="&#xf054;">
          </div>
        ...
        <div class="social-login clearfix">
          <a class="btn btn-primary  facebook" href="Switchlogin?type=loginForTeacher">
          <i class="icon-retweet"></i>切换到老师登录</a>
