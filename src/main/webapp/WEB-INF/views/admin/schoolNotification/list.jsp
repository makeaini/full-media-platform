...
<!-- 内容 -->
  <div class="container-fluid main-content">
                    ...
                    <tr>
                      ...
                      <td class="actions">
                        <div class="action-buttons">
                           ...
                           <a class="fancybox" href="#fancybox-example-update" onclick="update('${items.id}','${items.title}','${items.content}')">
        ...
        <!-- end DataTables Example -->
			...
			<!-- 新建－弹出层 -->
           <div id="fancybox-example" style="display: none;width:500px;">
                  <h4>添加 </h4>
          ...
          <div class="form-horizontal">
            ...
            <div class="col-md-10">
              <input class="form-control" id="name" name="title" placeholder="名称" type="text">
            </div>
          </div>
          </div>
           <div class="row">
          <div class="form-horizontal">
            ...
            <div class="col-md-10">
               <textarea id="update_remark" name="content" class="form-control" rows="3"></textarea>
...
<!-- 更新－弹出层 -->
    <div id="fancybox-example-update" style="display: none;width:500px;">
                  <h4>修改 </h4>
       	<form action="createOrUpdateToFind" method="post">
                  <div class="row"> 
          <div class="form-horizontal">
            <label class="control-label col-md-2">标题</label>
            <div class="col-md-10">
              <input class="form-control" id="update_title" name="title" placeholder="名称" type="text">
            </div>
          </div>
          </div>
           <div class="row">
          <div class="form-horizontal">
            <label class="control-label col-md-2">内容</label>
            <div class="col-md-10">
                  <textarea id="update_content" name="content" placeholder="内容"class="form-control" rows="3"></textarea>
              <input class="form-control" id="update_id" name="id" placeholder="内容" type="hidden">
