...
<!--                   </div> -->
              ...
              <div class="widget-content padded">
               <div class="col-lg-12">
                ...
                <c:choose>
                  <c:when test="${file.fileType=='VIDEO' and file.videoDec=='DECODING'}">
                   ...
                   <c:when test="${file.fileType=='VIDEO' and file.videoDec=='NONE'}">
                    	 <li class="col-lg-2 col-sm-3 col-xs-6 col-md-2">
	...
	function deleteById(){
		...
		$.post("${ctx}/personalfile/batchdeletefile",{"fileIds":deleteIds},function(data){
			if(data.returnCode=="success"){
				...
				reposne_url+="?pageNo="+pageNo+"&fileType=VIDEO";
